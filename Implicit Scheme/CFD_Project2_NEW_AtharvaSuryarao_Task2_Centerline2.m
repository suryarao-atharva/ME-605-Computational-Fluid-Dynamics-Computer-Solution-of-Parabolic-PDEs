...
% Plotting the temperature along centerline x, y = 40

[m,n] = size(T_centerLine_2);
rows_required2 = round(linspace(1, m, 6)); % We get six equally spaced intervals
T_centerLine_2_subset = T_centerLine_2(rows_required2, :);
